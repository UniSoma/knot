...
(defvar knot-list-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (keymap-set map "?" #'knot)
    (keymap-set map "l" #'knot-list-view-list)
    (keymap-set map "r" #'knot-list-view-ready)
    (keymap-set map "b" #'knot-list-view-blocked)
    (keymap-set map "c" #'knot-list-view-closed)
    (keymap-set map "f" #'knot-list-filter)
    (keymap-set map "F" #'knot-list-clear-filters)
    (keymap-set map "o" #'knot-list-sort)
    (keymap-set map "g" #'knot-refresh)
    ...
    (keymap-set map "U" #'knot-list-unmark-all)
    (keymap-set map "D" #'knot-deps-transient)
    (keymap-set map "L" #'knot-links-transient)
    (keymap-set map "T" #'knot-tags-transient)
    map)
...
(defvar knot-show-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (keymap-set map "?" #'knot)
    (keymap-set map "g" #'knot-refresh)
    (keymap-set map "q" #'knot-show-quit)
    (keymap-set map "RET" #'knot-show-RET)
    (keymap-set map "+" #'knot-show-add-at-point)
    (keymap-set map "-" #'knot-show-remove-at-point)
    (keymap-set map "]" #'knot-show-next-ticket)
    (keymap-set map "[" #'knot-show-prev-ticket)
    (keymap-set map "," #'knot-update-from-show)
    (keymap-set map "s" #'knot-start)
    (keymap-set map "x" #'knot-close)
    ...
    (keymap-set map "n" #'knot-show-add-note)
    (keymap-set map "E" #'knot-show-edit-via-emacsclient)
    (keymap-set map "D" #'knot-deps-transient)
    (keymap-set map "L" #'knot-links-transient)
    (keymap-set map "T" #'knot-tags-transient)
...
(defvar knot-capture-mode-map
  (let ((map (make-sparse-keymap)))
    (keymap-set map "C-c C-c" #'knot-capture-commit)
    (keymap-set map "C-c C-k" #'knot-capture-discard)
    map)
...
(defvar knot-deps-mode-map
  (let ((map (make-sparse-keymap)))
    ...
    (keymap-set map "?" #'knot)
    (keymap-set map "g" #'knot-refresh)
    (keymap-set map "f" #'knot-deps-toggle-full)
    (keymap-set map "q" #'knot-deps-quit)
